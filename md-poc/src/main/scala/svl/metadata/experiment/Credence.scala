...
object Credence extends App {
  ...
  import svl.metadata.experiment.Credence.AttrDataTypes._
...
//----------------------------------------------------------------------------------------------------------------------
  ...
  import svl.metadata.experiment.Credence.FileType._
  import svl.metadata.experiment.Credence.UserType._
